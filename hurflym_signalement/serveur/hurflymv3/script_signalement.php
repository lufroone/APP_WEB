...
<head>
    ...
    <link rel="stylesheet" href="signalement_2.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
...
<body>
    <div class="header">
        <a><img id="logo_1" src="../image/Hurflym_logo_colore_2.png" width="300" height="150"></a>
    </div>
    <?php
        if(isset($_POST['id'])){
            echo($_POST['id']);
...
';
    ...
    <script type="text/javascript" src="../arborescence_back+front/index_v2__Local_8.js"></script>
