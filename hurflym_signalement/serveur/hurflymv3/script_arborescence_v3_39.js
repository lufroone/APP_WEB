...
async function ajout_element(){
    ...
    await ajout_lieu(profondeur,nom_,localisation_,profondeur_);
    const n_element = creation_element(ID_ajout_lieu,nom_,localisation_,profondeur_);
...
async function mise_en_place_signalement(ID_Signalement, Nom_Signalement){
    ...
    ajout_signalement_a_element(profondeur, ID_Signalement, Nom_Signalement);
}

function mise_en_place_des_signalements_dans_larborescence(){
    for(var i=0;i<Signalement_.length;i++){
        if(Signalement_[i]["ID_Noeud"] != 0){
            ajout_signalement_a_element(Signalement_[i]["ID_Noeud"],Signalement_[i]["ID_Signalement"],Signalement_[i]["Nom_signalement"])
        }
    }
}

function ajout_signalement_a_element(profondeur, ID_Signalement, Nom_Signalement){
    const bandeau = document.createElement("div");
    bandeau.classList.add("gestion_element");
...
async function changement_detat_signalement(){
    alert(await fetch("http://hurflym.fr/arborescence_back+front/modification_etat_signalement.php?ID_Incidence="+profondeur+"&Nouvel_Etat="+document.getElementById("etat_signalement").value+"&ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;}));
...
async function changement_detat_incident(){
    alert(await fetch("http://hurflym.fr/arborescence_back+front/modification_etat_incident.php?ID_Incidence="+profondeur+"&Nouvel_Etat="+document.getElementById("etat_incident").value+"&ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;}));
    await request_incidents_globaux();
    remise_a_zero("gestion_incident");
...
async function valider_le_choix_des_propriétés(){
    ...
    reader.addEventListener("load", async () => {
        ...
        await fetch("http://hurflym.fr/arborescence_back+front/modification_de_la_personalisation.php", {method:"POST", body: formData}).then(res => res.json()).then(data => {return data;});
      }, false);
    if (file) {
...
async function recuperation_information_personnalisation_etablissement(){
    let Personnalisation = await fetch("http://hurflym.fr/arborescence_back+front/recuperation_de_la_personalisation.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
    console.log(Personnalisation);
    document.getElementById("couleur_de_fond").value = Personnalisation[0]["Couleur_1"];
    document.getElementById("couleur_de_cadre").value = Personnalisation[0]["Couleur_2"];
    document.getElementById("couleur_exceptionnel").value = Personnalisation[0]["Couleur_3"];

    document.getElementById("faux_body").style.backgroundColor = Personnalisation[0]["Couleur_1"];
    document.getElementById("faux_cadre").style.backgroundColor = Personnalisation[0]["Couleur_2"];
    document.getElementById('faux_bandeau').style.backgroundColor = Personnalisation[0]["Couleur_3"];
    document.getElementById("faux_trait").style.backgroundColor = Personnalisation[0]["Couleur_3"];
...
async function suppression_de_ladmin(ID_Admin){
    ...
    await fetch("http://hurflym.fr/arborescence_back+front/supression_admin.php?ID_Professionnel="+ID_Admin).then(res => res.json()).then(data => {return data;});
...
async function modification_de_mot_de_passe(){
    ...
    await fetch("http://hurflym.fr/arborescence_back+front/ajout_admin.php?Nouveau_mot_de_passe="+nouveau_mdp+"&Nouveau_mot_de_passe_deuxieme="+nouveau_mdp_deuxieme).then(res => res.json()).then(data => {return data;});
}
...
async function request_connexion(){
	...
	ID_etablissement = await fetch("http://hurflym.fr/arborescence_back+front/page_ajax.php?Pseudo=maison&Mot_de_passe=maison").then(res => res.json()).then(data => {return data;});
...
async function request_equipement(){
	Equipement = await fetch("http://hurflym.fr/arborescence_back+front/recup_equipement.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
	//console.log(Equipement);
}

async function request_signalement(){
    console.log('1.1');
	Signalement_ = await fetch("http://hurflym.fr/arborescence_back+front/recup_signalement.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
    console.log('1.2');
    liste_associe_au_signalement = await fetch("http://hurflym.fr/arborescence_back+front/recup_liste_associe_au_signalement.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
    console.log('1.3');
    //console.log(Signalement_);
    //console.log(liste_associe_au_signalement);
}
...
async function request_template(){
	template_ = await fetch("http://hurflym.fr/arborescence_back+front/recup_template.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
    liste_associe_au_template = await fetch("http://hurflym.fr/arborescence_back+front/recup_liste_associe_au_template.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
    //console.log(template_);
    //console.log(liste_associe_au_template);
}

async function request_ep(){
	Ep = await fetch("http://hurflym.fr/arborescence_back+front/recup_ep.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
}

async function request_incidents_globaux(){
    Incident_globaux = await fetch("http://hurflym.fr/arborescence_back+front/recup_incidents_globaux.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
}

async function demande_noeud_0(){
    Noeud_0 = await fetch("http://hurflym.fr/arborescence_back+front/demande_0.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
}

async function recursive_read(ID_Noeud_Precedent){

	const element_fils = await fetch("http://hurflym.fr/arborescence_back+front/recup_noeud_fils.php?ID_Noeud="+ ID_Noeud_Precedent).then(res => res.json()).then(data => {return data;});
...
async function request_arborescence(){
	...
	ID_First_Element = await fetch("http://hurflym.fr/arborescence_back+front/recup_first_element.php?ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
...
async function Connexion(){
    ...
    Lecture_element();
    mise_en_place_des_signalements_dans_larborescence();
...
async function ajout_signalement(Parametre,Values){
	return await fetch("http://hurflym.fr/arborescence_back+front/ajout_signalement.php?Parametre="+Parametre+"&Values="+Values+"&ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
}

async function supression_signalement(ID_Signalement){
	await fetch("http://hurflym.fr/arborescence_back+front/supression_signalement.php?ID_Etablissement="+ID_etablissement+"&ID_Signalement="+ID_Signalement).then(res => res.json()).then(data => {return data;});
}

async function remise_a_zero_signalement(ID_Signalement){
    await fetch("http://hurflym.fr/arborescence_back+front/remise_a_zero_signalement.php?ID_Etablissement="+ID_etablissement+"&ID_Signalement="+ID_Signalement).then(res => res.json()).then(data => {return data;});
}

async function modifier_signalement_sql(ID_Signalement,ID_Equipement){
    await fetch("http://hurflym.fr/arborescence_back+front/mise_a_jour_signalement.php?ID_Etablissement="+ID_etablissement+"&ID_Signalement="+ID_Signalement+"&ID_Equipement="+ID_Equipement).then(res => res.json()).then(data => {return data;});
}

async function recherche_sql_signalement(Nom_Recherche){
    return await fetch("http://hurflym.fr/arborescence_back+front/recherche_signalement.php?ID_Etablissement="+ID_etablissement+"&Nom_Recherche="+Nom_Recherche).then(res => res.json()).then(data => {return data;});
}

async function association_dun_signalement_a_un_lieu(ID_Lieu, ID_Signalement){
    await fetch("http://hurflym.fr/arborescence_back+front/association_signalement_a_un_lieu.php?ID_Signalement="+ID_Signalement+"&ID_Lieu="+ID_Lieu+"&ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
}

//-----------------------------------------------------------------------------------------------------------------------------------------------------------------

async function ajout_template(Parametre,Values){
	return await fetch("http://hurflym.fr/arborescence_back+front/ajout_template.php?Parametre="+Parametre+"&Values="+Values+"&ID_Etablissement="+ID_etablissement).then(res => res.json()).then(data => {return data;});
}

async function supression_template(ID_Template){
	await fetch("http://hurflym.fr/arborescence_back+front/supression_template.php?ID_Etablissement="+ID_etablissement+"&ID_Template="+ID_Template).then(res => res.json()).then(data => {return data;});
}

async function remise_a_zero_template(ID_Template){
    await fetch("http://hurflym.fr/arborescence_back+front/remise_a_zero_template.php?ID_Etablissement="+ID_etablissement+"&ID_Template="+ID_Template).then(res => res.json()).then(data => {return data;});
}

async function modifier_template_sql(ID_Template,ID_Equipement){
    await fetch("http://hurflym.fr/arborescence_back+front/mise_a_jour_template.php?ID_Etablissement="+ID_etablissement+"&ID_Template="+ID_Template+"&ID_Equipement="+ID_Equipement).then(res => res.json()).then(data => {return data;});
}

async function recherche_sql_template(Nom_Recherche){
    return await fetch("http://hurflym.fr/arborescence_back+front/recherche_template.php?ID_Etablissement="+ID_etablissement+"&Nom_Recherche="+Nom_Recherche).then(res => res.json()).then(data => {return data;});
}
...
async function ajout_equipement(Nom_equipement_,ID_Categorie_Equipement_,Image_Equipement_,Description_Equipement_,ID_Etablissement_){
	await fetch("http://hurflym.fr/arborescence_back+front/ajout_equipement.php?Nom_Equipement="+Nom_equipement_+"&ID_Categorie_Equipement="+ID_Categorie_Equipement_+"&Image_Equipement="+Image_Equipement_+"&Description_Equipement="+Description_Equipement_+"&ID_Etablissement="+ID_Etablissement_).then(res => res.json()).then(data => {return data;});
}

async function supression_equipement(ID_Equipement_){
	await fetch("http://hurflym.fr/arborescence_back+front/supression_equipement.php?ID_Equipement="+ID_Equipement_).then(res => res.json()).then(data => {return data;});
}
...
async function modifier_equipement(ID_Equipement,nouveau_nom_,nouvelle_description_,nouvelle_categorie_secondaire_,nouvelle_image){
    await fetch("http://hurflym.fr/arborescence_back+front/modification_equipement.php?ID_Equipement="+ID_Equipement+"&Nouveau_Nom="+nouveau_nom_+"&Nouvelle_Description="+nouvelle_description_+"&Nouvelle_Categorie_Secondaire="+nouvelle_categorie_secondaire_+"&Nouvelle_Image="+nouvelle_image).then(res => res.json()).then(data => {return data;});
}
...
async function recherche_sql_equipement(Recherche_Nom_,Recherche_Description_,Recherche_Categorie_,Recherche_Image_,ID_etablissement_){
    return await fetch("http://hurflym.fr/arborescence_back+front/recherche_equipement.php?Nom_Equipement="+Recherche_Nom_+"&Description_Equipement="+Recherche_Description_+"&ID_Categorie_Equipement="+Recherche_Categorie_+"&Image_Equipement="+Recherche_Image_+"&ID_Etablissement="+ID_etablissement_).then(res => res.json()).then(data => {return data;});
}
...
async function ajout_equipement_particulier(Nom_Ep_,Description_Ep_,ID_Categorie_Equipement_,Image_Equipement_,ID_Etablissement_){
	return await fetch("http://hurflym.fr/arborescence_back+front/ajout_equipement_particulier.php?Nom_Ep="+Nom_Ep_+"&Description_Ep="+Description_Ep_+"&ID_Categorie_Equipement="+ID_Categorie_Equipement_+"&Image_Equipement="+Image_Equipement_+"&ID_Etablissement="+ID_Etablissement_).then(res => res.json()).then(data => {return data;});
}

async function supression_equipement_particulier(ID_Ep_){
	await fetch("http://hurflym.fr/arborescence_back+front/supression_equipement_particulier.php?ID_Ep="+ID_Ep_).then(res => res.json()).then(data => {return data;});
}
...
async function modifier_equipement_particulier(ID_Equipement,nouveau_nom_,nouvelle_description_,nouvelle_categorie_secondaire_,nouvelle_image){
    await fetch("http://hurflym.fr/arborescence_back+front/modification_equipement_particulier.php?ID_Equipement="+ID_Equipement+"&Nouveau_Nom="+nouveau_nom_+"&Nouvelle_Description="+nouvelle_description_+"&Nouvelle_Categorie_Secondaire="+nouvelle_categorie_secondaire_+"&Nouvelle_Image="+nouvelle_image).then(res => res.json()).then(data => {return data;});
}
...
async function recherche_sql_equipement_particulier(Recherche_Nom_,Recherche_Description_,Recherche_Categorie_,Recherche_Image_,ID_etablissement_){
    return await fetch("http://hurflym.fr/arborescence_back+front/recherche_equipement_particulier.php?Nom_Equipement="+Recherche_Nom_+"&Description_Equipement="+Recherche_Description_+"&ID_Categorie_Equipement="+Recherche_Categorie_+"&Image_Equipement="+Recherche_Image_+"&ID_Etablissement="+ID_etablissement_).then(res => res.json()).then(data => {return data;});
}

async function association_dun_ep_a_un_lieu(ID_Lieu, ID_Ep){
    await fetch("http://hurflym.fr/arborescence_back+front/association_ep_a_un_lieu.php?ID_Ep="+ID_Ep+"&ID_Lieu="+ID_Lieu).then(res => res.json()).then(data => {return data;});
}

//----------------------------------------------------------------------------------------------------------------------------------------------------------------

async function ajout_lieu(Precedent_,Nom_Element_,Localisation_,Profondeur_){
	ID_ajout_lieu = await fetch("http://hurflym.fr/arborescence_back+front/ajout_lieu.php?Precedent="+Precedent_+"&Nom_Element="+Nom_Element_+"&Localisation="+Localisation_+"&Profondeur="+Profondeur_).then(res => res.json()).then(data => {return data;});
}

async function supression_lieu(ID_Noeud_){
    await fetch("http://hurflym.fr/arborescence_back+front/supression_lieu.php?ID_Noeud="+ID_Noeud_).then(res => res.json()).then(data => {return data;});
}

async function modification_lieu(ID_Noeud_,Nom_,Localisation_){
    await fetch("http://hurflym.fr/arborescence_back+front/modification_noeud.php?ID_Noeud="+ID_Noeud_+"&Nom="+Nom_+"&Localisation="+Localisation_).then(res => res.json()).then(data => {return data;});
}

async function recherche_lieu(Nom_Element_){
    return await fetch("http://hurflym.fr/arborescence_back+front/recherche_noeud.php?Nom_Element="+Nom_Element_).then(res =>res.json()).then(data => {return data;});
}

async function deplacer_lieu(ID_Noeud_, Precedent_){
    await fetch("http://hurflym.fr/arborescence_back+front/deplacer_noeud.php?ID_Noeud="+ID_Noeud_+"&Precedent="+Precedent_).then(res =>res.json()).then(data => {return data;});
}

//---------------------------------------------------------------------------------------------------------------------

async function recherche_categorie(ID_categorie_){
    return await fetch("http://hurflym.fr/arborescence_back+front/recherche_categorie.php?ID_Categorie="+ID_categorie_).then(res =>res.json()).then(data => {return data;});
}
...
async function demande_de_qrcode_pour_signalement(ID_Signalement){
    await fetch("http://hurflym.fr/arborescence_back+front/demande_de_qrcode.php?ID_Signalement="+ID_Signalement).then(res =>res.json()).then(data => {return data;});
}

async function changement_dactif_signalement(ID_Signalement){
    var nouvel_etat = await fetch("http://hurflym.fr/arborescence_back+front/changement_detat_actif_signalement.php?ID_Signalement="+ID_Signalement+"&ID_Etablissement="+ID_etablissement).then(res =>res.json()).then(data => {return data;});
    if(nouvel_etat == 1){
...
async function suppression_dun_signalement_pour_un_lieu(ID_Signalement){
    await fetch("http://hurflym.fr/arborescence_back+front/suppression_dun_signalement_pour_un_lieu.php?ID_Signalement="+ID_Signalement+"&ID_Etablissement="+ID_etablissement).then(res =>res.json()).then(data => {return data;});
    const signalement_dans_arborescence = document.getElementById("signalement_a_mettre_en_place"+ID_Signalement);
...
async function demande_de_qrcode_pour_ep(ID_Ep){
    await fetch("http://hurflym.fr/arborescence_back+front/demande_de_qrcode_ep.php?ID_Ep="+ID_Ep).then(res =>res.json()).then(data => {return data;});
}

async function changement_dactif_ep(ID_Ep){
    var nouvel_etat = await fetch("http://hurflym.fr/arborescence_back+front/changement_detat_actif_ep.php?ID_Ep="+ID_Ep).then(res =>res.json()).then(data => {return data;});
    if(nouvel_etat == 1){
...
async function suppression_dun_ep_pour_un_lieu(ID_Ep){
    await fetch("http://hurflym.fr/arborescence_back+front/suppression_dun_ep_pour_un_lieu.php?ID_Ep="+ID_Ep).then(res =>res.json()).then(data => {return data;});
    const signalement_dans_arborescence = document.getElementById("ep_a_mettre_en_place"+ID_Ep);
    signalement_dans_arborescence.parentElement.removeChild(signalement_dans_arborescence);
    request_ep();
}
...
async function recuperation_des_statistiques(){
    statistique = await fetch("http://hurflym.fr/arborescence_back+front/recuperation_des_statistiques.php?ID_Etablissement="+ID_etablissement).then(res =>res.json()).then(data => {return data;});
}

async function recuperation_des_admins(){
    liste_admins = await fetch("http://hurflym.fr/arborescence_back+front/recuperation_des_admins.php?ID_Etablissement="+ID_etablissement).then(res =>res.json()).then(data => {return data;});
