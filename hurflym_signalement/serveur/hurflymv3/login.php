...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../arborescence_back+front/login.css">
    </head>
    <body>
        <div class="fond"></div>
        <div class="boite_du_milieu">
            ...
            <div class="SSO">
                <div class="bouton_SSO">
                    <a class="link" href="https://accounts.google.com/o/oauth2/v2/auth?scope=email&access_type=online&response_type=code&redirect_uri=http://localhost/connect.php&client_id=<?= GOOGLE_ID?>">
            ...
            <div class="connexion">
                <div class="identifiant">
                    <label class="label_identifiant">Mail Utilisateur :</label><br>
                ...
                <div class="bouton">
                    ...
                    <a href="http://hurflym.fr/arborescence_back+front/inscription.php" class="bouton_">Inscription</a>
                </div>
            </div>
    ...
    <script type="text/javascript" src="../arborescence_back+front/connexion_3.js"></script>
