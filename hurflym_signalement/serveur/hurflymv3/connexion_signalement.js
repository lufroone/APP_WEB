async function connexion(){
    ...
    let Information_utilisateur = await fetch("http://hurflym.fr/arborescence_back+front/recuperation_des_informations_utilisateurs.php", {method:"POST", body: formData}).then(res => res.json()).then(data => {return data;});
    ...
    try{
        ...
        if(Information_utilisateur[0]["validation"] == "true"){
            ...
            try{
                await fetch("http://hurflym.fr/arborescence_back+front/creation_de_cookie_utilisateur.php", {method:"POST", body: formData}).then(res => res.json()).then(data => {return data;});
            ...
            window.location.replace("/arborescence_back+front/index_v2__local.php");
...
async function inscription(){
    ...
    if(verif_mail == 1){
        ...
        let validation = await fetch("http://hurflym.fr/arborescence_back+front/requete_dinscription.php", {method:"POST", body: formData}).then(res => res.json()).then(data => {return data;});
...
async function verifMail(){
    ...
    let verification_mail = await fetch("http://hurflym.fr/arborescence_back+front/verification_dadresse_mail.php", {method:"POST", body: formVerifMail}).then(res => res.json()).then(data => {return data;});
