<?php 
    ...
    header("Content-Type: text/javascript");
        ...
        $categorie_premiere = $conn->prepare('SELECT ID_Ep,ID_Source,Nom_Ep,Description_Ep,ID_Noeud FROM Equipement_Particulier__Local WHERE ID_Etablissement="'.$_GET["ID_Etablissement"].'"');
        ...
        while ($row = $result_cat_1->fetch_assoc()) {
            ...
            {
                $json .= '{ "ID_Ep" : "'.$row["ID_Ep"].'","ID_Source" : "'.$row["ID_Source"].'","Nom_Ep" : "'.$row["Nom_Ep"].'","Description_Ep" : "'.$row["Description_Ep"].'","ID_Noeud" : "'.$row["ID_Noeud"].'"}';
