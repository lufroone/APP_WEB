...
try{
    $response = $client->request('POST', 'https://oauth2.googleapis.com/token', [
        'form_params' => [
            ...
            'redirect_uri' => 'http://localhost/connect_signalement.php',
    ...
    if($response->email != ''){
        ...
        header('Location: /hurflym_signalement/local/arborescence_back+front/index_v2__local.php?ID_Source='.$_COOKIE["id_signalement_hurflym"]);
        exit();
    }
