...
<html>
        ...
        <div class="boite_du_milieu">
            ...
            <div class="SSO">
                <div class="bouton_SSO">
                    <a class="link" href="https://accounts.google.com/o/oauth2/v2/auth?scope=email&access_type=online&response_type=code&redirect_uri=https://hurflym.fr/connect.php&client_id=<?= GOOGLE_ID?>">
    ...
    <script type="text/javascript" src="../arborescence_back+front/connexion_4.js"></script>
