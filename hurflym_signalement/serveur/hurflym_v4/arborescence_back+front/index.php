...
<html>
    <head>
        <meta charset="utf-8">
        <title>Acceuil</title>
        <link rel="stylesheet" href="../arborescence_back+front/index_5.css">
    </head>
    <body>

    <div class="header">
        <div id="logo">
            <a src="../arborescence_back+front/index.php"><img src="../image/Hurflym_logo_colore_2.png" height="100" width="200"></a>
        </div>
        <div class="menu_connexion">
            <a class="identification" href="https://hurflym.fr/arborescence_back+front/page_utilisateur.php">Accès à son compte</a>
            ...
            <a class="identification" href="https://hurflym.fr/arborescence_back+front/login_administrateur.php">Administration</a>
        </div>
