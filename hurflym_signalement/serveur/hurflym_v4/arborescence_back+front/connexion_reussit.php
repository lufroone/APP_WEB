...
?>
    ...
    <div class="section" id="section1">
        ...
        <div class="signalement_en_cours_de_traitement">
        <?php
        $i = 1;
            ...
            while($row1 = $nb_etablissement->fetch_assoc()){
                $incident_signalement = $conn->prepare("SELECT * FROM Incidence".$i."__Local WHERE ID_Utilisateur = ".$ID_Utilisateur['ID_Utilisateur']." AND Etat_incident != '5'");
