...
function mise_en_URL(){
    ...
    //    data: 'toilette_salle='+toilette_sale&'papier_toilette='+papier_toilette&'chasse_deau='+chasse_deau&'lampe_toilette='+lampe_toilette&'sol_sale='+sol_sale&'porte_casse='+porte_casse&'lampe_espace_deau='+lampe_espace_deau&'lavabo_sale='+lavabo_sale&'plus_de_savon='+plus_de_savon&'miroir_sale='+miroir_sale&'robinet_casse='+robinet_casse&'seche_main='+seche_main&'sopalin='+sopalin&'commentaire='+commentaire,
    //    success: function(response) {
    //        //alert(response);
    //    }
    //});
    //$.post(window.location.search,{toilette_sale: toilette_sale,papier_toilette: papier_toilette,chasse_deau: chasse_deau,lampe_toilette: lampe_toilette,sol_sale: sol_sale,porte_casse: porte_casse,lampe_espace_deau: lampe_espace_deau,lavabo_sale: lavabo_sale,plus_de_savon: plus_de_savon,miroir_sale: miroir_sale,robinet_casse: robinet_casse,seche_main: seche_main,sopalin: sopalin,commentaire: commentaire},function(data){
    //    alert(data);
    //});
    alert(window.location.pathname);
    $.post("index_local.php",{id: 10});
