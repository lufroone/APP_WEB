<?php
    ...
    require 'arborescence_back+front/connexion_bdd_config.php';
?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/arborescence_179.css">
    ...
    <div class="page_principal">
        ...
        <div id="partie4" class="partie">
            ...
            <canvas id="graphique1" arialabel="chart" role="img"></canvas>
	        <!-- Créer un selecteur pour Nom_Element -->
	        <label for="nom-element">Nom_Element : </label>
	        <select id="nom-element" name="nom-element" onchange="changement_de_graphique_chatGPT4()">
	        	<option value="">Tous les éléments</option>
	        	<?php
	        		// Récupération des options du selecteur depuis la base de données
	        		$sql = "SELECT DISTINCT Nom_Element FROM Noeud__Local ORDER BY Nom_Element ASC";
	        		$result = $conn->query($sql);

	        		if ($result->num_rows > 0) {
	        			while($row = $result->fetch_assoc()) {
	        				echo "<option value='" . $row["Nom_Element"] . "'>" . $row["Nom_Element"] . "</option>";
	        			}
	        		} else {
	        ...
	        <!-- Afficher le graphe -->
	        <canvas id="graphique" arialabel="chart" role="img" width="500px" height="500px"></canvas>
        ...
        <div id="partie5" class="partie">
            <div class='centre'>
                <div class='partie_gauche'>
                    ...
                    <input class="color" type="color" id="--couleur-de-fond" name="couleur_de_fond"><br>
                    <label>Couleur de cadre</label><br>
                    <input class="color" type="color" id="--couleur-de-cadre" name='couleur_de_cadre'><br>
                    <label>Couleur exceptionnel</label><br>
                    <input class="color" type="color" id="--couleur-exceptionnel" name="couleur_exceptionnel"><br>
                    <label>Couleur ecriture</label><br>
                    <input class="color" type="color" id="--couleur-ecriture" name="couleur_ecriture"><br>
                    <label>Couleur bouton</label><br>
                    <input class="color" type="color" id="--couleur-bouton" name="couleur_bouton"><br>
                    <label>Couleur bouton ecriture</label><br>
                    <input class="color" type="color" id="--couleur-bouton-ecriture" name="couleur_bouton_ecriture"><br>
                    <label>Couleur de lombre du bouton</label><br>
                    <input class="color" type="color" id="--couleur-de-lombre-du-bouton" name="couleur_de_lombre_du_bouton"><br>
                    <label>Police_de_caractere</label><br>
                    <input type="text" id="police_de_caractere" name="police_de_caractere" onchange="modifier_police_de_caractere()"><br>
                ...
                <div class="partie_droite">
                    ...
                    <div id="fausse_page">
                        <div id="faux_bandeau">
                            <img src="../local/image/logo_efrei.png" id="faux_logo" width="100px" height="50px">
                        </div>
                        <div id="faux_body">
                            <div id="faux_equipement">
                                <img class="fausse_image" src="../image/bar-chart.png" width="200px" height="200px">
                                <h3 id="faux_nom_equipement">Ceci est un exemple</h3>
                            </div>
                            <button id="faux_button3">Envoyer !</button>
        ...
        <div id="partie6" class="partie">
            <h1>Vous pouvez gérer vos Admins ici ansi que votre mot de passe</h1>
            <br>
            <br>
            <h1>Voici la liste de vos administrateurs</h1>
            <div id="liste_des_admins">
                <div></div>

            </div>
            <div class="choix" id="ajout_dadministrateur" onclick="popup('ajout_dun_administrateur',1)">Ajouter un nouvel administrateur</div>
            <div class="choix" id="modification_de_mot_de_passe" onclick="popup('modifier_mot_de_passe',1)">Modifier son mot de passe</div>
        </div>
            ...
            <div id="ajout_dun_administrateur" class="popup_ajout_dun_administrateur">
                <div class="formulaire_ajout_dun_administrateur">
                    <div class="gestion_element">
                        <h1 class="text_haut_popup">Veuillez renseigner les informations necessaires a la creation de votre administrateur :</h1>
                        <div class="cross" onclick="popup('ajout_dun_administrateur',0)">&times;</div>
                    </div>
                    <div class="liste_des_choix">
                        <label>Nom :</label>
                        <input type="text" id="nom_administrateur" name="nom_administrateur">
                        <label>Prénom :</label>
                        <input type="text" id="prenom_administrateur" name="prenom_administrateur">
                        <label>Mail Administrateur</label>
                        <input type="text" id="mail_administrateur" name="mail_administrateur">
                        <label>Username :</label>
                        <input type="text" id="username_administrateur" name="username_administrateur">
                        <label>Mot de passe :</label>
                        <input type="text" id="mot_de_passe_administrateur" name="mot_de_passe_administrateur">


                        <div class="choix" onclick="ajout_dun_administrateur();popup('ajout_dun_administrateur',0)">Ajouter</div>
                    </div>
                </div>
            </div>

            <div id="modifier_mot_de_passe" class="popup_modifier_mot_de_passe">
                <div class="formulaire_modifier_mot_de_passe">
                    <div class="gestion_element">
                        <h1 class="text_haut_popup">Quel est le nouveau mot de passe que vous souhaitez adopté?</h1>
                        <div class="cross" onclick="popup('modifier_mot_de_passe',0)">&times;</div>
                    </div>
                    <div class="liste_des_choix">
                        <label>Nouveau mot de passe :</label>
                        <input type="text" id="nouveau_mot_de_passe" name="nouveau_mot_de_passe">
                        <label>Répétition :</label>
                        <input type="text" id="nouveau_mot_de_passe_deuxieme" name="nouveau_mot_de_passe_deuxieme">


                        <div class="choix" onclick="modification_de_mot_de_passe();popup('modifier_mot_de_passe',0)">Modifier</div>
                    </div>
                </div>
            </div>
    ...
    <!-- <script type="module" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.7.1/chart.js"></script> -->
    <script type="module" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.7.1/chart.min.js"></script>
    <script type="text/javascript" src="../local/arborescence_back+front/script_arborescence_v3_13.js"></script> 
    <!-- <script type="text/javascript" src="script_arborescence_v3_9.js"></script> -->
