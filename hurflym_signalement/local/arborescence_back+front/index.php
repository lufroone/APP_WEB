...
<html>
    ...
    <div class="header">
        ...
        <div class="menu_connexion">
            <a class="identification" href="http://localhost/hurflym_signalement/local/arborescence_back+front/page_utilisateur.php">Accès à son compte</a>
            ...
            <a class="identification" href="http://localhost/hurflym_signalement/local/arborescence_back+front/login_administrateur.php">Administration</a>
        </div>
    ...
    <div class="Presentation">
        ...
        <div class="premiere_ligne">
            <div class="rectangle_de_presentation" id="rdp1">
                <img src="../../image/working.png" height="200" width="200">
