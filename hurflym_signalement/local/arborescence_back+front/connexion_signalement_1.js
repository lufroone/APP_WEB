async function connexion(){
    ...
    try{
        ...
        if(Information_utilisateur[0]["validation"] == "true"){
            ...
            window.location.replace("/hurflym_signalement/local/arborescence_back+front/index_v2__local.php");
...
var myInput = document.getElementById("mot_de_passe_utilisateur"); 
