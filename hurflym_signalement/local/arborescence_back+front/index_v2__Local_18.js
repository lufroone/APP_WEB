...
async function recup_activation_signalement(){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_activation_signalement.php?ID_Signalement="+info_Source[0]["ID_Signalement"]+"&ID_Etablissement="+info_Source[0]["ID_Etablissement"]).then(res => res.json()).then(data => {return data;});
}

async function recup_activation_equipement_particulier(){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_activation_ep.php?ID_Ep="+info_Source[0]["ID_Ep"]+"&ID_Etablissement="+info_Source[0]["ID_Etablissement"]).then(res => res.json()).then(data => {return data;});
}

async function recup_info_ep(info_Source){
    info_ep = await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_ep_en_particulier.php?ID_Ep="+info_Source[0]["ID_Ep"]).then(res => res.json()).then(data => {return data;});
...
async function recup_information_signalement(ID_Source){
    info_Source = await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_info_source.php?ID_Source="+ID_Source).then(res => res.json()).then(data => {return data;});
}

async function recup_liste_equipement_signalement(info_Source){
    liste_associe_au_signalement = await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_liste_complete_associe_au_signalement.php?ID_Etablissement="+info_Source[0]["ID_Etablissement"]).then(res => res.json()).then(data => {return data;});
    liste_equipement_signalement = await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_index_signalement.php?ID_Signalement="+info_Source[0]["ID_Signalement"]+"&ID_Etablissement="+info_Source[0]["ID_Etablissement"]).then(res => res.json()).then(data => {return data;});
}
...
async function recup_information_personalisation(ID_Etablissement){
    ...
    //
    Info_personalisation = await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_info_personalisation.php?ID_Source="+ID_Source+"&ID_Etablissement="+ID_Etablissement).then(res => res.json()).then(data => {return data;});
...
async function ajout_de_lincident_a_la_base_de_donne(ID_Etablissement,ID_Signalement,Commentaire_signalement,ID_Utilisateur,Parametre,Argument){
    ...
    await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/ajout_incident.php?ID_Etablissement="+ID_Etablissement+"&Parametre="+Parametre+"&Arguments="+Argument+"&ID_Signalement="+ID_Signalement+"&Commentaire_Signalement="+Commentaire_signalement+"&ID_Utilisateur="+ID_Utilisateur).then(res => res.json()).then(data => {return data;});
}
...
async function Creation_recup_incident(ID_Etablissement,ID_Signalement,Commentaire_signalement,ID_Utilisateur,Parametre,Argument){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/ajout_recup_incident.php?ID_Etablissement="+ID_Etablissement+"&Parametre="+Parametre+"&Arguments="+Argument+"&ID_Signalement="+ID_Signalement+"&Commentaire_Signalement="+Commentaire_signalement+"&ID_Utilisateur="+ID_Utilisateur).then(res => res.json()).then(data => {return data;});
}

async function Verification_du_signalement_parloi_de_Ben_Ford(nombre_de_signalements){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/script_analyse_de_ben_ford.php?nombre_dequipement="+nombre_de_signalements).then(res => res.json()).then(data => {return data;});
}
...
async function creation_pepin_par_equipement(equipement_defectueux,ID_Etablissement,ID_Signalement,Commentaire_signalement,ID_Utilisateur){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/ajout_pepin.php?ID_Equipement="+equipement_defectueux+"&ID_Etablissement="+ID_Etablissement+"&ID_Signalement="+ID_Signalement+"&Commentaire_Signalement="+Commentaire_signalement+"&ID_Utilisateur="+ID_Utilisateur).then(res => res.json()).then(data => {return data;});
}

async function recuperation_de_pepins_de_lutilisateur(ID_Utilisateur){
    await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recherche_pepin.php?ID_Utilisateur="+ID_Utilisateur).then(res => res.json()).then(data => {return data;});
}

async function lancement_du_script_de_verif_incident_et_utilisateur(ID_Utilisateur, ID_Etablissement, ID_Equipement){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/verif_incident_et_utilisateur.php?ID_Utilisateur="+ID_Utilisateur+"&ID_Etablissement="+ID_Etablissement+"&ID_Equipement="+ID_Equipement).then(res => res.json()).then(data => {return data;});
}



async function recuperation_de_lid_noeud_du_signalement(ID_Signalement,ID_Etablissement){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_ID_noeud_signalement.php?ID_Signalement="+ID_Signalement+"&ID_Etablissement="+ID_Etablissement).then(res => res.json()).then(data => {return data;});
}

async function recuperation_du_nom_du_lieu(ID_Noeud){
    return await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_nom_element.php?ID_Noeud="+ID_Noeud).then(res => res.json()).then(data => {return data;});
}

let domaine_de_moderation = [];

async function recursive_domaine_de_moderation(ID_Noeud){
    const element_parent = await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/recup_noeud_parent.php?ID_Noeud="+ ID_Noeud).then(res => res.json()).then(data => {return data;});
...
async function envoi_du_mail_aux_administrateurs_concerne(ID_Noeud,ID_Etablissement,titre_du_mail,message_a_envoyer){
    await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/envoi_du_mail_a_ladministrateur.php?ID_Noeud="+ID_Noeud+"&ID_Etablissement="+ID_Etablissement+"&message="+message_a_envoyer+"&titre_du_mail="+titre_du_mail).then(res => res.json()).then(data => {return data;});
    page(27);
}
...
async function envoie_du_mail_et_ajout_base_de_donnee_ep(Commentaire_ep){
    await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/ajout_incident_ep.php?&ID_Ep="+info_Source[0]["ID_Ep"]+"&Commentaire_Ep="+Commentaire_ep+"&ID_Utilisateur="+info_utilisateur[1]["ID_Utilisateur"]).then(res => res.json()).then(data => {return data;});
    //await fetch("http://localhost/hurflym_signalement/local/arborescence_back+front/envoi_du_mail_a_ladministrateur_ep.php?ID_Noeud="+ID_Noeud+"&ID_Etablissement="+ID_Etablissement+"&message="+message_a_envoyer+"&titre_du_mail="+titre_du_mail).then(res => res.json()).then(data => {return data;});
}
