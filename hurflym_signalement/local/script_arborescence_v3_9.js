...
var nomElementSelect = document.getElementById("nom-element");
...
nomElementSelect.addEventListener("change", function() {
    // Récupérer la valeur sélectionnée
    var nomElementSelectionne = nomElementSelect.value;
    ...
    fetch("donnees_graphique.php?nom_element=" + encodeURIComponent(nomElementSelectionne))
        ...
        .then(data => {
            ...
            graphique.data.datasets[0].data = data.data;
                    // Mettre à jour le titre du graphe
        graphique.options.title.text = "Nombre d'incidences pour " + nomElementSelectionne;
