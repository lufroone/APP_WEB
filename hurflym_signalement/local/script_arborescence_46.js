...
function mise_a_jour_profondeur(){
    ...
    profondeur = this.parentElement.firstElementChild.id;
...
function creation_element(){
    ...
    nouveau_element.className = profondeur;
    console.log("element"+profondeur);
    ancien_element = document.getElementById(profondeur);
    console.log("element"+profondeur);
    ...
    nouveau_element.id = (profondeur+1);
